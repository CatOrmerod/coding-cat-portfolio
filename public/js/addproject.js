const addProjectHandler = async (event) => {
  ...
  if (projectTitle) {
    const response = await fetch(`/api/projects`, {
      method: "POST",
      body: JSON.stringify({ projectTitle, projectDescription, projectTools, projectRole, projectRepo, projectURL, projectScreenshot, projectPic }),
      headers: {
...
document
  ...
  .addEventListener("submit", addProjectHandler);
